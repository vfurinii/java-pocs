...
@DisplayName("DPK03_impl_1 Test Suite")
class DPK03_impl_1Test {
    ...
    class LookupTests {
        ...
        void shouldReturnNameForExistingId() {
            String result = DPK03_impl_1.lookup(idNameMap, 1);
        ...
        void shouldReturnNameForId2() {
            String result = DPK03_impl_1.lookup(idNameMap, 2);
        ...
        void shouldReturnNameForId3() {
            String result = DPK03_impl_1.lookup(idNameMap, 3);
        ...
        void shouldReturnKeyNotFoundForNonExistingId() {
            String result = DPK03_impl_1.lookup(idNameMap, 4);
        ...
        void shouldReturnKeyNotFoundForNullId() {
            String result = DPK03_impl_1.lookup(idNameMap, null);
            assertEquals("Key not found", result);
        }
        ...
        void shouldHandleEmptyMap() {
            ...
            String result = DPK03_impl_1.lookup(emptyMap, 1);
            assertEquals("Key not found", result);
        }
        ...
        void shouldWorkWithLargeIdNumbers() {
            ...
            String result = DPK03_impl_1.lookup(idNameMap, 999999);
        ...
        void shouldHandleMapWithMultipleEntries() {
            ...
            assertEquals("Person5", DPK03_impl_1.lookup(idNameMap, 5));
            assertEquals("Person10", DPK03_impl_1.lookup(idNameMap, 10));
        }
        ...
        void shouldPreserveOriginalMapAfterLookup() {
            ...
            DPK03_impl_1.lookup(idNameMap, 1);
            DPK03_impl_1.lookup(idNameMap, 100);
